...
let botonesInscribirme = document.querySelectorAll(".producto-inscribirme");
...
botonesCategorias.forEach(boton => {
    boton.addEventListener("click", (e) => {
        ...
        if (e.currentTarget.id != "todos") {
            ...
            tituloPrincipal.innerText = "Inscribete Ya!!!";
            cargarProductos(productos);
        }
...
function actualizarBotonesInscribirme() {
    botonesInscribirme = document.querySelectorAll(".producto-inscribirme");
